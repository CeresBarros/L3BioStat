...
\shadowbox{\parbox{4in}{\textbf{Objectifs de la séance} \\ Tester l'effet d'une variable discrète sur une variable continue par la méthode d'analyse de la variance à un ou deux facteurs contrôlés}}
